...
#include "LTL/Algorithm/AutomataStubbornTarjan.h"
...
namespace LTL {
    ...
    bool AutomataStubbornTarjan<W, G>::isSatisfied()
    {
     ...
     */
    template<typename W, typename G>
    void AutomataStubbornTarjan<W, G>::push(State &state, size_t stateid)
    {
        //const auto res = seen.add(state);
    ...
    template<typename W, typename G>
    void AutomataStubbornTarjan<W, G>::pop()
    {
    ...
    template<typename W, typename G>
    void AutomataStubbornTarjan<W, G>::popCStack()
    {
    ...
    template<typename W, typename G>
    void AutomataStubbornTarjan<W, G>::update(idx_t to)
    {
...
//#define PRINTF_NEXTRANS
    ...
    template<typename W, typename G>
    bool AutomataStubbornTarjan<W, G>::nexttrans(State &state, State &parent, DEntry &delem)
    {
    ...
    template<typename W, typename G>
    std::ostream &AutomataStubbornTarjan<W, G>::printTransition(size_t transition, uint indent, std::ostream &os)
    {
    ...
    template<typename W, typename G>
    void AutomataStubbornTarjan<W, G>::printTrace(std::stack<DEntry> &&revdstack, std::ostream &os)
    {
        if constexpr (!SaveTrace) {
            return;
        } else {
