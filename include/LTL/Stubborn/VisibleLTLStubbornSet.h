...
namespace LTL {
    class VisibleLTLStubbornSet : public PetriEngine::StubbornSet {
    public:
        VisibleLTLStubbornSet(const PetriEngine::PetriNet &net, const std::vector<PetriEngine::PQL::Condition_ptr> &queries)
