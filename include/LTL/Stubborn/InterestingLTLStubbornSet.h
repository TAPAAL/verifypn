...
namespace LTL {
    class InterestingLTLStubbornSet : public PetriEngine::StubbornSet, public SuccessorSpooler {
    public:
        InterestingLTLStubbornSet(const PetriEngine::PetriNet &net,
        ...
        ~InterestingLTLStubbornSet() = default;
