...
namespace PetriEngine {
    ...
    public:
        ...
        ResolutionResult resolve(const std::shared_ptr<std::string>& identifier, bool place) override {
   ...
   struct ExpandedArc
   {
       ExpandedArc(std::shared_ptr<std::string> place, size_t weight) : place(place), weight(weight) {}
        ...
        std::shared_ptr<std::string> place;
        size_t weight;
   };
    ...
    private:
        ...
        std::shared_ptr<std::string> getTransitionName(uint32_t transition);
        std::shared_ptr<std::string> getPlaceName(uint32_t place);
        ...
        std::shared_ptr<std::string> newTransName();
        ...
        std::vector<std::shared_ptr<std::string>> _initfire;
        std::unordered_map<std::string, std::vector<std::shared_ptr<std::string>>> _postfire;
