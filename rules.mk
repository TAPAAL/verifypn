...
debug: CFLAGS += -g -DENABLE_MC_SIMPLIFICATION -DENABLE_TAR -fsanitize=address
debug: LDFLAGS += -g -Wl,-Bstatic -lz3 -lgmp -Wl,-Bdynamic -lpthread -DENABLE_MC_SIMPLIFICATION -DENABLE_TAR -fsanitize=address
debug: $(TARGET)
